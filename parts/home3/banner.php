...
<section class="banner-style1">
  <div class="slider-bg-slide" data-options='{
                ...
                "slides":
                    [
                    { "src": "assets/images/slides/banner-style1-1.jpg" },
                    { "src": "assets/images/slides/banner-style1-2.jpg" },
                    { "src": "assets/images/slides/banner-style1-3.jpg" }
                    ],
                    "transition": "fade",
                    "animation": "random",
  ...
  <div class="container">
    <div class="banner-style1__content">
      <h3>Find Your Dream Yacht</h3>
      <h2>Find Your Dream Yacht</h2>
