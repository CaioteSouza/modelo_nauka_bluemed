<?php $head_title = "Blog Standard || Nauka || Nauka PHP Template" ?>
            ...
            <div class="col-xl-8 col-lg-6 col-md-12">
                <div class="blog-details__content">
                    ...
                    <div class="single-blog-style1 single-blog-style1--style3">
                        <div class="img-box">
                            <img src="assets/images/blog/blog-standard-1.jpg" alt="Image">
                    ...
                    <div class="single-blog-style1 single-blog-style1--style3">
                        <div class="img-box">
                            <img src="assets/images/blog/blog-standard-2.jpg" alt="Image">
                            <div class="overlay-content">
                                <div class="date-box">
                                    <div class="icon">
                                        <i class="icon-time"></i>
                                ...
                                <div class="title">
                                    <h3>
                                        <a href="blog-single.php">
                                            The Finest Dining Experiences at the World’s Top
                                        </a>
                                    </h3>
                                </div>
                            </div>
                    ...
                    <div class="single-blog-style1 single-blog-style1--style3">
                        <div class="img-box">
                            <img src="assets/images/blog/blog-standard-3.jpg" alt="Image">
                            <div class="overlay-content">
                                <div class="date-box">
                                    <div class="icon">
                                        <i class="icon-time"></i>
                                ...
                                <div class="title">
                                    <h3>
                                        <a href="blog-single.php">
                                            41m Benetti superyacht LexSea sold by Record
                                        </a>
                                    </h3>
                                </div>
                            </div>
                    ...
                    <div class="single-blog-style1 single-blog-style1--style3">
                        <div class="img-box">
                            <img src="assets/images/blog/blog-standard-4.jpg" alt="Image">
                            <div class="overlay-content">
                                <div class="date-box">
                                    <div class="icon">
                                        <i class="icon-time"></i>
                                ...
                                <div class="title">
                                    <h3>
                                        <a href="blog-single.php">
                                            We organize your full-service yacht charter
                                        </a>
                                    </h3>
                                </div>
                            </div>
                    ...
                    <div class="single-blog-style1 single-blog-style1--style3">
                        <div class="img-box">
                            <img src="assets/images/blog/blog-standard-5.jpg" alt="Image">
                            <div class="overlay-content">
                                <div class="date-box">
                                    <div class="icon">
                                        <i class="icon-time"></i>
                                ...
                                <div class="title">
                                    <h3>
                                        <a href="blog-single.php">
                                            Navigating the Dos and Don’ts on Board
                                        </a>
                                    </h3>
                                </div>
                            </div>
                    ...
                    <div class="single-blog-style1 single-blog-style1--style3">
                        <div class="img-box">
                            <img src="assets/images/blog/blog-standard-6.jpg" alt="Image">
                            <div class="overlay-content">
                                <div class="date-box">
                                    <div class="icon">
                                        <i class="icon-time"></i>
                                ...
                                <div class="title">
                                    <h3>
                                        <a href="blog-single.php">
                                            Yacht Charter Tips for First-Time Renters
                                        </a>
                                    </h3>
                                </div>
                            </div>
