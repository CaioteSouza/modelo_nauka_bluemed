<?php $head_title = "Yacht Grid || Nauka || Nauka PHP Template" ?>
<?php $body_class = "body-bg-1" ?>
<?php require_once('parts/layout/top-layout.php'); ?>
<?php require_once('parts/header/header.php'); ?>

<?php
$page_title = "Yacht Grid";
...
<!--Start Yacht Grid Style1-->
<section class="yacht-grid-style1">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-6 co-md-12">
                <div class="yacht-grid-style1__content">
                    <div class="row">

                        <!--Start Single Yacht Style2 -->
                        <div class="col-xl-6">
                            <div class="single-yacht-style2">
                                <div class="img-box">
                                    <img src="assets/images/resources/yacht-v2-1.jpg" alt="Image">
                                    <div class="overlay-content">
                                        <div class="top-box">
                                            <div class="title">
                                                <h3>
                                                    <a href="#">Galibar Escort</a>
                                                </h3>
                                            </div>
                                            <div class="value">
                                                <h3>$250/Day</h3>
                        ...
                        <!--End Single Yacht Style2 -->
                        <!--Start Single Yacht Style2 -->
                        <div class="col-xl-6">
                            <div class="single-yacht-style2">
                                <div class="img-box">
                                    <img src="assets/images/resources/yacht-v2-2.jpg" alt="Image">
                                    <div class="overlay-content">
                                        <div class="top-box">
                                            <div class="title">
                                                <h3>
                                                    <a href="#">Cuddy Cabins</a>
                                                </h3>
                                            </div>
                                            <div class="value">
                                                <h3>$400/Day</h3>
                        ...
                        <div class="col-xl-6">
                            <div class="single-yacht-style2">
                                <div class="img-box">
                                    <img src="assets/images/resources/yacht-v2-3.jpg" alt="Image">
                                    <div class="overlay-content">
                                        <div class="top-box">
                                            <div class="title">
                                                <h3>
                        ...
                        <div class="col-xl-6">
                            <div class="single-yacht-style2">
                                <div class="img-box">
                                    <img src="assets/images/resources/yacht-v2-4.jpg" alt="Image">
                                    <div class="overlay-content">
                                        <div class="top-box">
                                            <div class="title">
                                                <h3>
                                                    <a href="#">Cruise Yacht</a>
                                                </h3>
                                            </div>
                                            <div class="value">
                                                <h3>$360/Day</h3>
